    ...
    await Multimedia.insertMany([
      {
        ...
        tipo: "serie",
        descripcion:
          "Drama y fantasia mediaval basada en el libro de George R.R 'A Song of Ice and Fire'",
        temporadas: 8,
      },
    ]);
...
/* precargarEtiquetas = async () => {
  ...
  if (count === 0) {
    await Etiqueta.insertMany([
      {
        nombre: "Critica",
        descripcion: "Reseña crítica y detallada de la obra a analizar",
      },
      {
        nombre: "Recomendacion",
        descripcion: "Sugerencia positiva para ver la obra",
      },
      { nombre: "Comentario", descripcion: "Opinión personal sobre la obra" },
      {
        nombre: "Analisis",
        descripcion: "Examen profundo de los elementos de la obra",
      },
      {
        nombre: "Resumen",
        descripcion: "Síntesis breve de la trama o contenido de la obra",
      },
    ]);
